...
import {
  GoogleOauthService,
  GoogleUserInfo,
} from 'src/google-oauth/google-oauth.service';

@Injectable()
export class GoogleapisOauthService extends GoogleOauthService {
  private readonly logger = new Logger(GoogleapisOauthService.name);
